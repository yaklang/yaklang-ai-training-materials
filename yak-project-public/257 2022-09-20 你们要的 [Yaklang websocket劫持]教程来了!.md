...
![image](static/a2ae4aa72793c1a1.png)

![image](static/8198ff273d977b04.png)
...
![image](static/c91655f3aa449b3e.png)
...
![image](static/29df8ded66bfca54.png)
...
![image](static/a4fc9fc10b5b9859.png)

挂载代理访问http://127.0.0.1:8884/，出现websocket升级的请求，手动放行:

![image](static/433ba895c5c9bb19.png)

等待websocket协议升级完成后，我们成功劫持到了websocket的请求，按下劫持响应并修改请求内容，最后按下提交数据:

![image](static/73805c00b345580b.png)

可以看到服务器已经接收到修改过后的请求:

![image](static/11b1c9703955eee6.png)

同时我们拦截到了服务器的响应，修改响应内容然后按下提交数据:

![image](static/0b48ee0910000b61.png)

发现浏览器中显示我们修改过后的响应:

![image](static/5e01b8a032ee3ba9.png)
...
![image](static/de3067d7159dbb13.png)

跳转到websocket fuzzer页面，我们尝试建立连接:

![image](static/416443769096dc28.png)

建立websocket连接完成后可以在右侧看到实时的服务器请求与响应:

![image](static/796b73beed819e0f.png)

我们尝试在下方发送数据框发送websocket请求:

![image](static/0b26177ac63f6b81.png)
