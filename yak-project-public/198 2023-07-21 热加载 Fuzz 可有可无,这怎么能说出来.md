...
日期: 2023-07-21 | 原文: <https://mp.weixin.qq.com/s/oBuCxHvp8ee1bYp0eBfyBg>

![image](static/2a7b6bc1cb3ee0ea.gif)
...
**![image](static/61d5751d35861dd1.png)**
...
**![image](static/b7784efc0bfca180.png)所以，热加载存在的意义究竟是什么呢 ？![image](static/a524cf74d3038ef5.png)**
...
![image](static/3ed9c3cc426cb95a.png)

01

劫持某后台登录数据包发现account为明文password 加密且含有一个token签名。

![image](static/c045e112e0fee4da.png)

02

检索前端源代码，发现两个参数，一个参数t1，一个参数s1。t1参数为token值 s1参数目前还未知。

![image](static/b6881d0bab4c8af5.png)
...
![image](static/95610352c6e587d7.png)
...
![image](static/9fbf833846ddecd8.png)
...
![image](static/85aaf14d28a94427.png)

06

调试执行，加密成功。

![image](static/5b60afe33fc2ace8.png)

07

点击复制。

![image](static/3cccfaae248e2eee.png)

08

插入需要fuzz的参数处，如下：

**![image](static/d1cfd7efc96a07fe.png)**
