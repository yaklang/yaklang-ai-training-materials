...
日期: 2024-11-08 | 原文: <https://mp.weixin.qq.com/s/_jQIomZ5lJ1Gx2f7p_ZK5Q>
...
![image](static/74ba5f91081bcee9.png)

![image](static/0e141de122adc67b.png)

验证码一般会在注册、登录等功能，用来防止自动化工具的攻击。一般的验证码生成过程如下图所示：

![image](static/95440a7f854d4981.png)
...
![image](static/6cf364bd8771225a.png)
...
![image](static/b3be39171f4d5b6b.png)

最后可以看到验证码成功被识别出来

![image](static/9990a503a0588f1e.png)

![image](static/bc8b57ffc864e8ac.png)

我们在社群接到小伙伴反馈说，所有设置都按照教程设置了，为什么验证码很多都没识别出来呢？这是这位小伙伴的热加载代码：

![image](static/c1941396253f07c3.png)

![image](static/167b65f491f9231f.png)
...
![image](static/bd9e9e5c64f3d9fe.png)
