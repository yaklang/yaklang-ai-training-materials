...
日期: 2023-02-03 | 原文: <https://mp.weixin.qq.com/s/oQOHPowLN45SHDn2i7pizg>

01

背景

![image](static/eceb493fe9975d0d.png)
...
![image](static/1575c9f592e48ed5.png)
...
![image](static/e921f686157df9e6.png)

![image](static/87776c3b285ee71f.png)
...
![image](static/56a441e75ea30a1b.png)

### **编写规则保存生效**

![image](static/b6f440920611d6ae.png)
...
![image](static/663dcfb18d86f430.png)

在添加规则之后，我们设置规则对所有流量部分都检测生效

![image](static/92458fc3eb2d1238.png)

配置好之后，我们访问 example.com 的流量，将会看到在 History 中，example.com 的流量被新增了一个 Header

![image](static/c6b55f7c0d784e66.png)
...
![image](static/d3028c428dedc78f.png)
...
![image](static/3ec0fc5689669ad6.png)

**4**有趣的结果**

加载之后，通过一些流量，我们发现 isAdmin=true 被加在了每一个请求的 Get 参数位置。

![image](static/168eb40a6ff66665.png)

当然，`FuzzGetParams` 也仅仅是 `fuzz.HTTPRequest` 的一个功能而已，我们可以用它实现各种各样复杂的情况，比如 Get Post Json Data 等数据的修改，甚至文件上传、Chunk 等。

![image](static/f6a72eca2b4e4d24.gif)

![image](static/3dea63c0d5e40223.png)

Yakit v1.1.7-sp1 发布！！！

![image](static/ddbe0b0a5951a8b5.png)

![image](static/f5a88b461f068abb.png)

![image](static/7cb23d7bb78f7e40.png)

![image](static/2593e509ccec2464.png)

![image](static/fbac5c950196c9dd.png)
...
![image](static/f8d4af270aef9464.png)

![image](static/a62d17ccbef2ac11.png)

![image](static/b2545d31dd82f111.png)

![image](static/d2e8b1a7a78591f6.png)
