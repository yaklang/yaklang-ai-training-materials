...
日期: 2025-12-05 | 原文: <https://mp.weixin.qq.com/s/pbedzP2LRu8kSWNsFXfmHQ>

![image](static/39cfc50df3e604a8.webp)

![image](static/ab00ce3bff7b16b3.png)

![image](static/6b52b86faf42efcc.jpg)
...
![image](static/b5c9052e23df5d98.png)

![image](static/d412ceeea0ff3a08.png)

**后端：**极其简单，它只是模拟一个功能，用户单例级别的创建和销毁容器。

下面是一个后端代表逻辑图：

![image](static/fcf7baa81cc7aef4.png)

**前端**(**HTML**with**JavaScript**)：**

![image](static/4069481a05e64249.png)

![image](static/85d286263b5fb9bb.png)

#### **正常使用销毁测试**

1、启动vulinbox，点击**逻辑场景**的**用户容器**靶场，登陆用户；

![image](static/fbbee272cd86a6b3.jpg)

**2、**操**作**: 点击 "Activate" 按钮。建立一个容器；

![image](static/352ccef570b92a4f.png)
...
![image](static/3d35390ab1f044a5.png)
...
![image](static/55447544cef7215f.png)
...
![image](static/acc23c6681732c4f.png)

- **MITM 日志：**正确捕获和打印出了 mock 信息。

![image](static/fe24e3d9bf3acd32.png)

![image](static/48f74fa5143b8cb5.png)
