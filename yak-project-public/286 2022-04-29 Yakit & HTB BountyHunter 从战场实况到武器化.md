...
日期: 2022-04-29 | 原文: <https://mp.weixin.qq.com/s/-jANeiDufVV0CMu-8-YmeQ>
...
![image](static/f3fa5e4227b2b350.png)

起手：确定攻击路径

大致观察之后，我们最直接的丢在 Yakit 中扫描端口开启插件跑跑看：

![image](static/5dbbacc5ed156f7b.png)

![image](static/a57e8412997ab7ac.png)
...
![image](static/7119ade5e2a40bde.png)

XXE 漏洞检查

我们看到参数是 XML 的时候，马上反应过来这应该是一个 XXE 漏洞，那么其实非常简单的，我们应该写一个可以用来测试的脚本：

![image](static/757bdfe3b98e6a62.png)
...
![image](static/aac5bbe50cf7a03d.png)
...
![image](static/70b5920e014ba2a9.png)
...
实际上，按理说我们 `{{url({{base64(<xml ... />)}})` 这样是最理想的，但是由于 fuzz 暂时无法支持编码嵌套，现在可用的替代方案是自己写一个 `codec` 插件来实现这个功能
