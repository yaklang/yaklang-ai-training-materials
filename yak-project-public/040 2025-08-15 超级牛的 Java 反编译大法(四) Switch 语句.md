...
日期: 2025-08-15 | 原文: <https://mp.weixin.qq.com/s/BdRPmRe-2FQshat1Xc7bUQ>
...
![image](static/ba11c50dc268dd97.jpg)

![image](static/b981f92b7b2f7e45.png)
...
![image](static/c14082f810c15526.png)

下图展示了常见的三种形态。

## 1、无 break 的贯穿式（fall-through）Switch

![image](static/7e68ec97486ad484.png)

特征：多个 case 可能顺序相连，形成贯穿；`default` 可能直接指向后继。

## 2、带 break 的结构化 Switch

![image](static/6520d30772d60694.png)
...
![image](static/bbdcc6153f1a1818.png)

在反编译层面，若满足数据与控制一致性约束（详见后文“ Default 判定策略”），可将“ `Switch 的后继语句”`等价视为 `default` 代码块。

## 4、多个流程控制关键词的 Switch 语句

![image](static/f96fd60414fc548e.png)

![image](static/efdf456a9de48167.png)
...
![image](static/b08926bc503262a5.png)
...
![image](static/7309dbc86b389f1d.png)
...
![image](static/3be096459d15a1cc.png)
...
![image](static/2db7bc04d1b7d6ff.png)
...
![image](static/ae958e99b38d3899.png)
...
![image](static/807a425204021d1d.png)
...
![image](static/314fb128e364c9bd.png)
