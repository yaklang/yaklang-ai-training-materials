...
日期: 2023-07-07 | 原文: <https://mp.weixin.qq.com/s/6H3WYJX3Qn5zQHo9Y4lA5g>

![image](static/78c622df7c44a00d.gif)

![image](static/03634e0b69b3fc59.png)

背景

![image](static/ce7b3bc0488a5124.png)
...
shiro 漏洞相关的原理以及利用工具已经有很多师傅分享了。如今主流的检测 Shiro Key 的方式是由 `l1nk3r`师傅分享的，使用一个空的*`SimplePrincipalCollection`*序列化后和要检测的 Key 进行加密作为 payload 发送，判断响应头中的 `deleteMe` 个数。
...
![image](static/a7e762c2a0d82488.png)
...
![image](static/60a5342d2d213250.png)
...
熟悉这四条链的师傅应该能知道，这四条链有一个共同点，那就是可以**利用 TemplatesImpl 执行字节码**，可以更加直观的感受一下：

![image](static/9746f95403ba5cc6.png)
