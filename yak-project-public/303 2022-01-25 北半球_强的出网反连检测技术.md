...
日期: 2022-01-25 | 原文: <https://mp.weixin.qq.com/s/pomP3qxQ6qDFm5aAQWPkiQ>
...
![image](static/ca29e6fd9700032a.png)
...
![image](static/82aa19a344682fe1.png)
...
![image](static/2a732f273b30fbb9.png)
...
![image](static/7b64b531be8b143e.png)
...
![image](static/028d883d06fcc99a.png)

当我们打开 Yakit “风险与漏洞” 页，我们看到如下内容

![image](static/03b29ec676756ae9.png)
...
![image](static/fa290b65e3423975.png)
...
![image](static/c0c1d53a1a182409.png)

我们配置好 Brigde 服务之后，访问

![image](static/9bec4718bebb9201.png)

Vulfocus 任意靶场，将会发现，MITM 被动扫描页面输出了内容。

![image](static/c1b8a18f4bdc8f27.png)

## 关键步骤 1：获取随机端口触发器

![image](static/2ebc3820f89336d4.png)

## 关键步骤 2: 使用 yak.fuzz 链式 API

![image](static/ddbbc4a1c51c77ba.png)

## 关键步骤 3：检查漏洞输出内容

![image](static/e3aaa0a585397d5e.png)
