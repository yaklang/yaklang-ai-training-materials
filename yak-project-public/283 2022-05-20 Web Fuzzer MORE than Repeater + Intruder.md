...
日期: 2022-05-20 | 原文: <https://mp.weixin.qq.com/s/sG9NLshZ8Q0l2yhvDcvSJA>
...
> 为什么发送原始数据包这么简单的事情，很多工具不支持，做不好，自己写的也各种小问题。甚至在 Burp 本身的一些细节处理也存在问题
...
![image](static/4c217de319494bca.png)
...
![image](static/5ba80a9e5a185338.png)
...
![image](static/77a79d8c2a33f9d3.png)
...
![image](static/9fa19a419a020351.png)
...
![image](static/1fd27366ee2c32eb.png)

当点击 “插入模糊测试字典标签” 之后将会看到如下对话框。

在新的框中，用户可以选择字典，同时查看里面的内容，在决定要选择哪个字典之后，可以点击 “小闪电” 或者 “选择该 Fuzz 标签”。自动把标签内容替换到 Web Fuzzer 中选中部分。

![image](static/0aca244821ded4bb.png)

![image](static/e60ee0f549bb5070.png)

在插入了新的标签之后，我们再点击 “发送数据包”，将会在表格中的 Payload 看到这次渲染的 “结果”。值得注意的是

![image](static/5266dd3d15bf426a.png)
...
1. 在最新的 Yak 引擎中 (yak-1.0.13-sp18)，劫持代理并不会为劫持到的请求增加 "Connection: close"。对于一些要通过 Connection: close 来判断是否被调试的 Web 应用来说，这种方式只能针对 Burpsuite。
2. Web Fuzzer 会对数据包进行修复，修复的内容如下：
3. Web Fuzzer 的模糊测试解决方案本质上是 Yak 语言 fuzz 模块的扩展
4. 本文介绍的几种常见的标签内容，在以下网站中可以找到详细的教程https://www.yaklang.io/docs/buildinlibs/lib_fuzz
...
虽然 Web Fuzzer 已经初具雏形，但是扪心自问一些细节仍然处理得还不够好，并且 Web Fuzzer 应该还可以支持更多更强的功能：
...
> 事物发展向好是一般规律，发展螺旋上升，偶有下降，希望大家都能以发展的眼光看问题，切忌停滞不前半途而废。

在 Web Fuzzer 静默灰度测试过程中，很多用户提供了非常宝贵的建议，甚至在这篇文章中，很多功能和想法的提出者都是大家非常熟悉的同学，感谢师傅们的鼎力帮助，顺序不分先后

@sucre @奶权 @timwhite @phith0n @cnstar @18 Xtreme @魔狼 @Devil @羲钺 @Tommy...

同时感谢在上一次 “Yakit 征文” 活动中积极投稿的同学

@剑思庭  [基于Yakit平台开发IRTeam插件exploit 西门子PLC](http://mp.weixin.qq.com/s?__biz=MzAxOTAzOTU3Mw==&mid=2247484312&idx=1&sn=0373d760889d0be295fcefd1d959e56a&chksm=9bcc57a2acbbdeb4a4ee0654dca3a7301067871b1eb7527702ddfd015350bd23884f546bcb73&scene=21#wechat_redirect)

@shangzeng [基于Yak的被动扫描jsonp识别](http://mp.weixin.qq.com/s?__biz=MzAxOTAzOTU3Mw==&mid=2247484463&idx=1&sn=672c1af75abd10dc46456c56ae4fb355&chksm=9bcc5015acbbd90377e831b23e19c8ce58665b5a39f48ec041f3d1badac98cf9485a06546464&scene=21#wechat_redirect)  @奶权  [Yak基础插件案例——CDN检测](http://mp.weixin.qq.com/s?__biz=MzAxOTAzOTU3Mw==&mid=2247484656&idx=1&sn=3391d3009a26c9e8141d84c9786efd7b&chksm=9bcc50caacbbd9dc4ea3d1e3720b0539d93e11c5bec13b508be907fe1228efb8e072bdf21033&scene=21#wechat_redirect)

@斑马还没睡 [从Redis未授权简单学习yak语言](http://mp.weixin.qq.com/s?__biz=MzAxOTAzOTU3Mw==&mid=2247484734&idx=1&sn=c684c5d6ebe05dbe0970db5c53fd97e3&chksm=9bcc5104acbbd8128671afd6228b12433d73b5a30256294fa2fc89e7b4b6fe80345bd514ed08&scene=21#wechat_redirect) @望川 [使用Yak搭建Log4j漏洞检测工具](http://mp.weixin.qq.com/s?__biz=MzAxOTAzOTU3Mw==&mid=2247484749&idx=1&sn=3ecec60c134cd5a93f77e8bd57fb108a&chksm=9bcc5177acbbd861a5405aa15b536d36d20d149c48b8995461ac9550ce64e64c8386a82d9f4e&scene=21#wechat_redirect)

@P0m32Kun [yakit向日葵远程命令执行检测插件](http://mp.weixin.qq.com/s?__biz=MzAxOTAzOTU3Mw==&mid=2247484777&idx=1&sn=1c5ad68bf2851ec6bff30a7d7ceb5e96&chksm=9bcc5153acbbd845b74b9236f91138f27ed3d1e0168298bc49fa20e988050b34537888ec488b&scene=21#wechat_redirect) @Cheliauk [使用Yakit进行常规渗透测试](http://mp.weixin.qq.com/s?__biz=MzAxOTAzOTU3Mw==&mid=2247484876&idx=1&sn=3690e6e306446fd628cf0aff547a4458&chksm=9bcc51f6acbbd8e0c8600e0639d0f4c59374fed718fca86f73e992f4020491f4602a6ca2db76&scene=21#wechat_redirect)
