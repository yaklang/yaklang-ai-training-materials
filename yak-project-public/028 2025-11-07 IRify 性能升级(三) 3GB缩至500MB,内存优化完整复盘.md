...
日期: 2025-11-07 | 原文: <https://mp.weixin.qq.com/s/38PcVk8CXLC4UCpffusZdA>

![image](static/58ebeb3f78c4aec5.webp)

![image](static/11b93e696b5b8eae.png)
...
![image](static/10932a94cf760a26.png)

![image](static/2abaaf0aaa377169.png)

在当前版本的 IRify 和命令行工具中，我们引入了新的扫描模式：“内存模式”：

![image](static/8ab50082227d8eb0.png)

![image](static/ef14531707012c3d.png)
...
![image](static/d11b77ea48ff6d9d.png)

在投入战斗之前，我们首先建立了一套可靠的“侦测-验证”反馈循环机制，这是我们所有后续工作的基础。

![image](static/b5618b939b555301.png)

- **测试框架**：我们构建了一套测试框架，可以对不同规模的 Java 项目进行完整的 SSA IR 构建。
- **周期性监控**：在框架中，我们集成了：

![image](static/8cc2ec53646e0656.png)
...
![image](static/3348339f4c948b1f.png)
...
![image](static/dbc69df8e404ea42.png)

![image](static/f628461ac10f934e.png)
...
![image](static/0b413e7023bfd18c.png)
...
![image](static/116f93ca04222e35.png)

![image](static/11b51e6f59086084.png)
...
![image](static/39e47ffb7ad4bf7f.png)

- **思路**: 为何问题依旧？我们退回到最原始的调试方法：日志追踪。

![image](static/5c489bfb3cb541e8.png)
...
![image](static/31140bb549389176.png)

在解决了所有内存泄漏后，我们得到了一个健康的、最终内存占用约 1.2GB 的程序。此时，pprof 的角色从“查漏”，变成了“减负”。

![image](static/0f7b73c6c6bc2fc5.png)
...
![image](static/c817f54e135f78d6.png)

![image](static/ea17b2a94efdf7d4.png)
...
![image](static/e6ab9c39a24b743b.png)

![image](static/998217b796fe66c2.png)
