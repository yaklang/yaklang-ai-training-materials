...
日期: 2024-02-29 | 原文: <https://mp.weixin.qq.com/s/cxu91N-6eu5RcdvXNaoEhA>
...
![image](static/4c79c2498a575869.png)
...
如果我们想要选择所有属性`lang`值为`"en"`的`<title>`元素，XPath表达式将会是：
...
至此，Yaklang支持了对XML格式进行模糊测试，我们可以像以前一样轻松地使用Yaklang的`fuzz`标准库来使用它：

![image](static/8ed344eb15b70cba.svg)
