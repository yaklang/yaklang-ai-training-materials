...
日期: 2024-03-14 | 原文: <https://mp.weixin.qq.com/s/zCFc2KXZPon-RKlfepBNpg>

![image](static/f32b74a58e24b8ba.png)
...
![image](static/ac3919926747090b.png)

![image](static/2b1f991ef26001c2.png)
...
![image](static/46e3609a7bb62cfe.png)

除此之外，每一条Codec方法的右侧都有收藏按钮，点击即可将其加入收藏，在顶部可以直接找到

![image](static/42f5dc75c1b954e0.png)
...
![image](static/21806605bab46163.png)
...
![image](static/ee2673667dfd7fbf.png)
...
![image](static/ab2a9f6be56f1103.png)

- 本地Codec插件：此处可以搜本地已有的Codec插件直接使用。当然也可以到Yakit插件商店里下载社区师傅分享的Codec插件使用。

![image](static/ee78730e5e1d3053.png)
...
![image](static/58ede004da6ee46b.png)
