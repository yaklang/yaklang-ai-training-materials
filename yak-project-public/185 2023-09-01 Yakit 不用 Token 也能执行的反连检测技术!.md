...
日期: 2023-09-01 | 原文: <https://mp.weixin.qq.com/s/cwpZtnnDi1OafQCMNuVMhg>

当我用搜索引擎，如谷歌和百度搜索“反连平台”四个字时，首页几乎所有的内容都是xray的反连平台。

**反连平台**

![image](static/8c257f07eb9de200.png)

![image](static/917720fb713df48d.png)
...
![image](static/80e9dd9571dbd43e.jpg)

反连平台其实并不好做，但YAK团队最大的优点就是擅于听取用户的声音～～

![image](static/af169f6b9a91230a.png)
...
![image](static/ba5b9d04dcde2780.jpg)
...
![image](static/b4760e7e00b5666c.png)

TCP-Portlog 用以检测 TCP 连接。

![image](static/bf613c6c69cd53c2.png)

Yso-Java Hack 用以检测反序列化、类加载、JNDI漏洞利用等Java中常见的几种类型漏洞。

![image](static/1f9a5381664521f8.png)
