...
日期: 2026-03-18 | 原文: <https://mp.weixin.qq.com/s/vYzIXAIQXlmuQD8Mb8xZyw>

![image](static/6063bae5fa7ea313.jpg)

![image](static/f584318e9564f9cb.png)

![image](static/39e34be514cc9e39.jpg)

![image](static/3c2c36563140403f.png)

**在开始之前，先启动** Vulinbox。启动之后，可以访问：http://127.0.0.1:18080/ ，如下：

![image](static/70c5fb0980c2c6e7.png)
...
![image](static/199608e0d59646d6.png)
...
![image](static/f1e510ed069b5940.png)
...
![image](static/4c7043267ec4ad87.png)
...
![image](static/db9b8c25edf51e34.png)
...
![image](static/b5624b6a8ec2a7fc.png)
...
![image](static/bad0e29902c49926.png)

到这里，脚本都已经准备好了。下面就是实际启用步骤。

在 Yakit 中进入全局热加载插件管理页面：

![image](static/cd281f94217abd53.png)
...
![image](static/2ca426f047351035.png)

3、将上面的完整脚本粘贴进去

4、保存并启用

![image](static/686c0389e9ed53da.png)
...
![image](static/4bce85f51bf04ca7.png)
...
![image](static/8489f9ea838eafc7.png)

我们点开详情，可以发现 `X-Auth-Signature` 已经被补上了：

![image](static/206f21b5114a4c69.png)
...
![image](static/fb266aba8379e0e2.png)

> 注意：此时浏览器还是正常的密文，但 MITM 保存到数据库里的那条 flow，被改成明文

![image](static/9f5bb13820e780e1.png)
...
![image](static/d25adf3dbd0b2a6f.png)

启动 vulinbox，搜索 “全局热加载” ，打开 "全局热加载 Pipeline"，向下滑动到 “前端实操台”：

![image](static/426344ef6ba471ea.png)

![image](static/336851a77b2a40d3.png)
...
![image](static/fce0899e108343aa.png)
...
![image](static/bfab234714dd5127.png)
...
![image](static/39b984e95f2b52b6.png)
...
![image](static/e9ba3b8dce4aa3f2.png)

### 2、启用模块 HotPatch

ITM 中的情况如下：

![image](static/ce293c3f53761905.png)
