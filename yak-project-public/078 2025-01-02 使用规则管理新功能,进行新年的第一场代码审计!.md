...
日期: 2025-01-02 | 原文: <https://mp.weixin.qq.com/s/IN707rBZtlfmUmDO05mCnw>
...
![image](static/3937bea77c66ece9.jpg)

![image](static/1dfeff2ca7269976.png)

![image](static/9d30d79ff9092775.png)

以下为该功能的大致一览。

![image](static/6f1d69eeee745b3a.png)

该模块可以分为两个部分，组别为规则的组管理，右边为规则的详细信息。

![image](static/96df8c6cb2156d08.png)

**组**除了方便管理规则外，主要作用是**在代码扫描中会按组选取规则进行扫描**

![image](static/65571d04b49880fb.png)
...
![image](static/6e9288befd6f779b.png)

创建规则功能的按钮在右上角，如图:

![image](static/acb029cd1781f2c2.png)

![image](static/136a62fd49594e64.png)

![image](static/e48a5b1bdf1f7f05.png)

一个完整的规则一般包含三个部分：规则描述、规则内容和规则输出。

如图:

![image](static/22f0b535200fd612.png)
