...
日期: 2023-06-16 | 原文: <https://mp.weixin.qq.com/s/BCt4XVjuoJ0hNibK6YbTBQ>

![image](static/78c622df7c44a00d.gif)
...
![image](static/cbd7df7c92dd7785.png)
...
![image](static/4f857f1d4ee0a45d.png)

使用自己的 SecureObjectInputStream 包裹输入流从中获取序列化数据。

![image](static/625ef907f73dd00b.png)
...
![image](static/220967203627d303.png)
...
![image](static/7a125779447f7353.png)

![image](static/1b79732cf35a8fc6.png)
...
![image](static/553400feba5ad82f.png)

这里抛出异常

![image](static/9444881788109935.png)

这里遍历了全部构造函数，寻找符合要求的构造函数，都找不到所以报错，这里阅读逻辑后发现和顺序没有关系，因为

![image](static/4d53d43ad8e6d1c8.png)

![image](static/0b46fea9c3fcd0bc.png)

无论运行多少次都会完整遍历 DeclaredCtor。那为什么进行多次反序列化后，就可以正常反序列化呢？继续向前看，在 ParserConfig 中

![image](static/2976fb0895e9442b.png)

在 build 之前把这个类缓存了，存在一个 static 的 mapping 中

![image](static/70871ac5907b8125.png)

在第二次反序列化时

![image](static/e50f05fafd0085bf.png)
...
![image](static/afebf972a2137a44.png)
...
![image](static/f915de7f107d38b3.png)

如果在 handles 中查到缓存的 obj，那就直接写 TC_REFERENCE

![image](static/c80eb556194ac472.png)
