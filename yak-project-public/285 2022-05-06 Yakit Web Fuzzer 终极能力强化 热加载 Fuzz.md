...
日期: 2022-05-06 | 原文: <https://mp.weixin.qq.com/s/WWSQq6tl66NlwAfuO6vVCA>
...
![image](static/0beaf4bdd781a639.png)

按图中配置好后，我们可以通过 “执行” 来调试上述标签渲染是否成功。

![image](static/a43f2dce27d608d9.png)
...
![image](static/9799b21c524d95ca.png)
...
![image](static/ac833086016c5aba.png)

于是我们就可以开心地免去编写完整的 Yak 脚本对其测试了。

![image](static/929a79dbc2954fda.png)
...
![image](static/20f9d5d0cadefd48.png)

Conclution

通常来说，我们的操作绝不止于此：

1. 如果需要 JS 执行，我们当然也可以用 `otto` 来直接执行对应的编码代码。
