...
![image](static/c3c63591b9c3fd23.png)

![image](static/010c8ff9235e794c.png)
...
![image](static/e18b1adf69222430.png)
...
![image](static/1a9e81df4514f60e.png)

选择想要成组的PoC，然后点击添加到组，并在搜索栏中写入你想要分组的名称，如果该组不存在，下方将会有一个新增分组的选项。勾选选项，再次点击添加到组，即可将这些PoC分类成组。

![image](static/10a76d26b3721d4d.png)

![image](static/6e7c4c4f1638f46d.png)

对成组的PoC进行批量执行，可以点击左上角的“批量执行”：

![image](static/808c03b8ababc283.png)
