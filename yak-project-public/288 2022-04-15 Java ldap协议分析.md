...
日期: 2022-04-15 | 原文: <https://mp.weixin.qq.com/s/tXe5cr12UQhhM_YU1hToxA>

![image](static/8eb21680e600b1c5.png)

什么是ldap

![image](static/b4373ba1f49a6a51.png)
...
![image](static/d59aed28c9f2f38b.png)
...
![image](static/7443c80e31ce9212.png)

通过命名服务，查询ldap，获取到LdapUrlContext，然后继续lookup

![image](static/f4251fe59f3dd2d0.png)

supper:GenericUrlContext

![image](static/8f43a550af2f11f3.png)

如图，首先执行getRootURLContext

![image](static/eed7822503077011.png)

然后如图

![image](static/0c55f0d22dbd3d21.png)
...
![image](static/510b525a3f762ce2.png)

p_lookup

![image](static/123811e461812f44.png)

c_lookup（LdapCtx）获取到对象

![image](static/2b5465c92affba19.png)

doSearchOnce开始搜索

![image](static/e755340b24ca969c.png)

![image](static/aff84aff9e1efddd.png)

![image](static/31bf138898382f80.png)

![image](static/b9618f599b7ae892.png)
...
![image](static/42803145073dec83.png)

身份认证

![image](static/57688e1c011748ab.png)

协议使用LdapV3

build the bind request（认证过程就叫做bind，bind request就是认证请求）

![image](static/ca415d08f58a9776.png)
...
![image](static/68f19b437c3fb0e6.png)
...
![image](static/c9f574220d86253f.png)
...
![image](static/13d2bac889f31b3c.png)
...
![image](static/12c3c13125cacd15.png)
