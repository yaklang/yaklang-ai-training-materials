...
日期: 2025-11-28 | 原文: <https://mp.weixin.qq.com/s/wdscwwq1_6yCs_FtsfCwMQ>

![image](static/6063bae5fa7ea313.jpg)

![image](static/53309e5b73f70af0.jpg)

![image](static/3dfebfb8d809ff28.png)

打开插件商店，搜索「证书生成」原生插件，证书类型选 CA，填写通用名（CN）和组织（O）即可：

![image](static/24e92783d1208957.png)

点击「额外参数」可补齐国家/省份/城市、有效期或自定义生效/失效时间。

![image](static/3ebde55ab8a1e6d6.png)

执行后自动拿到自签根证书和私钥，文件路径在界面下方可直接复制。

![image](static/b46b76ed0ed242d1.jpg)

适合快速搭建测试 PKI、配置浏览器/系统信任、或为 MITM/抓包工具准备可信根。

![image](static/70bc5ae3f9ffc71d.png)
...
![image](static/aad46c940c5839b0.png)
...
![image](static/92b8bd417109ed8c.png)
