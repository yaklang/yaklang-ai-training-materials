...
日期: 2024-12-19 | 原文: <https://mp.weixin.qq.com/s/oQeLRHrcdCw0QyM9WrPpQg>
...
![image](static/72459bf1431970f8.png)

![image](static/6f1aaea5df799a8b.png)
...
![image](static/d9ddea4a1e7d6567.png)

```
while x > 0:    print(1)    x-=1
```

![image](static/37e04972b482fc5c.png)

通过CFG可以清晰的看到程序的所有执行路径，有助于后续分析。

![image](static/ca7d7f8555725254.png)
...
![image](static/9df37f34c6b67f5d.png)
...
![image](static/3e0faa9c191c8a3e.png)

![image](static/7e98a7cd89daa7ad.png)

支配树可以展现出程序的所有代码执行路径和支配关系，清晰看出程序结构，便于后续分析。

![image](static/3d09d1dcadb9ea83.png)

反编译过程中首要目标是将字节码解析恢复为等价的源码，对于一些表达式的简化，语法糖的优化可以放到后面处理。那主要任务就是将CFG规约为一条线性的链表形式。

![image](static/b0e54b809b072e73.png)
...
![image](static/c6e056e8abfe2dda.png)
...
![image](static/ae8cd58f9866d805.png)

### **恢复变量名**

按照声明顺序将变量名设置为var0、var1......

![image](static/f087b1fab8514bea.png)
...
![image](static/0d4998c42db3fae6.png)
