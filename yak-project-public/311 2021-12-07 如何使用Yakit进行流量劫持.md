...
日期: 2021-12-07 | 原文: <https://mp.weixin.qq.com/s/fKiY1FTXmL3-AF62IzdLxA>

MITM的功能已经上线了一段时间，但一直没有好好介绍这个功能。在收集了众多用户对此功能的反馈后，推出1.0.10-beta15的版本对MITM的功能与交互进行了优化和升级

![image](static/304faa315ecd81a2.png)
...
![image](static/b9100d86ce56d65d.png)

![image](static/c91d50c659fce638.png)

Http history

查看历史的请求响应数据包并对数据包进行编解码操作，了解请求的详细信息，如需对数据包进行编辑调试，可发送到web fuzzer进行操作。

![image](static/eccffa0222d9d7df.png)
...
![image](static/f51357fa5fd9d1c2.png)
...
![image](static/195ba002f9372e0c.png)
