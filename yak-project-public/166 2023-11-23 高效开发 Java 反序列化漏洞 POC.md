...
日期: 2023-11-23 | 原文: <https://mp.weixin.qq.com/s/u-JoJbjymbMlQuQv7zOabA>

![image](static/f75786f4c6dd4041.jpg)
...
![image](static/7c916ad3f442dcfa.png)

![image](static/159b2d1c24b96381.svg)
...
![image](static/a9d4d3f21f2d3810.png)

先使用shiro插件扫描下key

![image](static/e62d5b0cf05e8e61.png)

可以看到key和利用链

![image](static/bb494d81fddafa27.png)
...
![image](static/49c2a01e7c6e3db4.png)
...
![image](static/6ce96a020eced88d.png)
...
![image](static/164e5c1b27664542.png)

下面开始编写payload，打开Yso-Java Hack页面，利用链选择cc3，恶意类选择DNSLog

![image](static/398d9fe62e8333ac.png)
...
![image](static/93a528fb309df852.png)
...
![image](static/d80ba7a15f01a8c7.png)

先生成一个dnslog，再配置payload

![image](static/d2b4d85b56d3ffdd.png)

打开/h2-console/test.do页面，配置Driver Class，和jdbc url，点击测试连接

![image](static/08336cf0d06cc0b0.png)

在yakit中可以看到请求记录如图。

![image](static/020feac4e5b12cae.png)
