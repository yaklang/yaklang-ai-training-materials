...
日期: 2024-03-22 | 原文: <https://mp.weixin.qq.com/s/fItvm9lwXlWnGo8_-JB-hA>
...
![image](static/28986f9cdebdede6.png)
...
这段代码可以理解为忽略所有*TC_RESET*，并调用handleReset，handleReset的作用是清空handle表，在序列化刚开始时清空handle表是没有影响的。这段代码运行在readObject0的开头，所以可以理解为忽略序列化数据前的所有*TC_RESET*
...
出现错误的位置在读取*REFERENCE*处，对读取到的handle强转为String出错。
...
![image](static/dbc18c409d992c1f.png)
