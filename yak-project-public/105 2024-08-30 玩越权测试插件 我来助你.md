...
> 在往期知识分享中，我们介绍了MITM插件现在能够使用Cli接受动态的配置参数，使得其功能得到很大地拓展。在《CLI参数助力MITM插件升级，起飞！》一文中，Rookie师傅便介绍了如何使用该功能编写越权插件。而最近，交互插件系统中上新了一些官方的插件，其中包括了Yak社区中小伙伴们需求声很高的越权插件以及两个小辅助插件。越权插件能够对存在可能的越权的数据包进行染色并做标记，相比以往具备更好地表现力。而两个小赋值插件能够对每个经过的报文修改成手动设置的Cookie和Header，渗透方便up up!
>
> 本期知识文章将介绍这些插件的用法并着重介绍越权插件的相关原理，学习完相关原理后，师傅们也能够开发出类似酷炫的插件!
