...
日期: 2024-06-27 | 原文: <https://mp.weixin.qq.com/s/Flr6Ws3kiy_ZZqyGHDWb8g>
...
![image](static/ed6682f433f6a919.png)
...
![image](static/994d56db22269664.png)

**RDP_NEG_REQ**

如下是协商请求的结构，其中requestedProtocols字段表明了客户端支持的协议

![image](static/29cf60c32bb57241.png)

**RDP_NEG_RSP**

在响应报文中选择了一种认证方式，接下来可以使用服务端支持的方式来认证。如下是所有的认证方式。

![image](static/7c5316a36349e769.png)
...
RDP认证过程可以使用Microsoft Negotiate协商认证方式，并采用对应的方式认证（RDP协议只支持上述的Credential Security Support Provider）

**CredSSP： 凭证安全支持提供**

如下是一个完整的认证过程

![image](static/666e348de6b32d0d.png)
...
![image](static/5bbd3bc686f35520.gif)
...
![image](static/10abf2d617991ff4.png)

**NTLMv2算法定义**

如下是官方对NTLMv2 hash计算的定义

![image](static/1b28f71b2c579052.png)
...
![image](static/514e53dd452dc03f.png)
...
![image](static/e4bd8c7c515363ca.png)
